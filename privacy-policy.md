...
ApolloAI built the ApolloAI app as a free app. This SERVICE is provided by ApolloAI at no cost and is intended for use as is.
...
Some of the third party services may use location information transmitted from users' mobile phones. We only use this information within the scope necessary for the designated service.  

### Device Information  
We collect information from your device in some cases. The information will be utilized for the provision of better service and to prevent fraudulent acts. The information that Apollo AI as itself collects can not be used to identify the user but the data that the third party services are using may be.
